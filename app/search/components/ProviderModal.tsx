...
export default function ProviderModal({ data, onClose }: any) {
  ...
  return (
    <Card className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <Card className="bg-white rounded ui-card-lg p-4 w-[90%] max-w-sm">
        ...
        <Button
          className="mt-4 bg-green-600 text-white w-full py-2 rounded ui-card"
        ...
        <Button
          className="mt-2 text-sm text-muted w-full"
          onClick={onClose}
        >
          Close
        </Button>
